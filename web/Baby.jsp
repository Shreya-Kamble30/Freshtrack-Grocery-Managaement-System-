...
<body>
    ...
    <section class="items">
        <%
            ...
            List<Product> dairyProducts = productDAO.getProductsByCategory(14); // Assuming 1 is the category ID for Dairy
        ...
        <div class="product-card" data-name="<%= product.getProductName() %>" data-price="<%= product.getPrice() %>">
            ...
            <div class="price">
                ...
                <form action="AddToCartServlet" method="post">
                    <input type="hidden" name="currentPage" value="Baby.jsp">
